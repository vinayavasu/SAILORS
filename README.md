...
The full mapping table is in [mapping.md](mapping.md). A coverage matrix showing what SAILORS covers directly, partially, and what companion controls fill the gaps is in [docs/owasp-coverage-matrix.md](https://github.com/vinayavasu/SAILORS/blob/main/docs/owasp-coverage-matrix.md)
