...
Fill in the review template for one feature.
...
See examples/refund-tool-review.md for the format and depth I am looking for.

**2. Try SAILORS-Verify and file a false-positive issue**
The proof-of-concept scanner in poc/ covers 5 of 7 checks using pattern matching. Pattern matching produces false positives.
...
The coverage matrix lists risks that SAILORS covers only partially, or that require a companion control (supply chain, data poisoning, unbounded consumption, inter-agent communication, and cloud AI service configuration).
