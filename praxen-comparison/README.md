...
This folder holds a real, complete comparison between SAILORS and Praxen (Steve Wilson's agent behavior verifier, built on the RAISE framework), done against FinBot, the OWASP Agentic AI CTF demo agent.
